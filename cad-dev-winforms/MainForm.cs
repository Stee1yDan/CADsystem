    ...
    public partial class MainForm : Form
    {
        ...
        else
        {
            for (int i = 0; i < this._STLData.Count; i++)
            {
                ...
                gl.Color(0.71f, 0.81f, 0.91f); gl.Vertex(this._STLData[i][0, 0], this._STLData[i][0, 1], this._STLData[i][0, 2]);
                gl.Color(0.73f, 0.83f, 0.93f); gl.Vertex(this._STLData[i][1, 0], this._STLData[i][1, 1], this._STLData[i][1, 2]);
                gl.Color(0.76f, 0.86f, 0.96f); gl.Vertex(this._STLData[i][2, 0], this._STLData[i][2, 1], this._STLData[i][2, 2]);
                gl.End();
            }
        }
        }
